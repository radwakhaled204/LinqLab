...
namespace SeedData
{
    public static class GetData
    {
        ...
        public static List<Customer> GetCustomers()
        {
            ...
            customers.Add(new Customer { id = 107, name = "AYMA", age = 31, isActive = false, joinDate = new DateTime(2022, 12, 24), categoryId = 1, spendAverage = 1900.0m, telephone = 259874689 });
