...
namespace SeedData
{
    public static class GetData
    {
        ...
        public static List<Customer> GetCustomers()
        {
            ...
            customers.Add(new Customer { id = 104, name = "Ghada H", age = 48, isActive = true, joinDate = new DateTime(2022, 8, 30), categoryId = 1, spendAverage = 4500.11m, telephone = 369852147 });
