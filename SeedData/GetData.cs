...
namespace SeedData
{
    public static class GetData
    {
        ...
        public static List<Customer> GetCustomers()
        {
            ...
            customers.Add(new Customer { id = 101, name = "Radwa Khal", age = 21, isActive = true, joinDate = new DateTime(2022, 10, 15), categoryId = 1, spendAverage = 1500.9m, telephone = 123456789 });
