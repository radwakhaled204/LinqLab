...
namespace SeedData
{
    public static class GetData
    {
        ...
        public static List<Customer> GetCustomers()
        {
            ...
            customers.Add(new Customer { id = 106, name = "Hadir Aym", age = 18, isActive = true, joinDate = new DateTime(2022, 11, 8), categoryId = 1, spendAverage = 8110.9m, telephone = 14256363 });
